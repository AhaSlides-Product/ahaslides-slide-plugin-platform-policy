...
| Role | Reviewer | Owns |
| --- | --- | --- |
| QA | Lily or Amber | Function, SDK use, data, edge cases (§4) |
| UI / UX | Lan | Design system, style, assets, accessibility (§5) |
| Marketing | Trent | Name, metadata, tagging & categorisation (§6) |
